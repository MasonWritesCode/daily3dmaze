...
export const forgotPasswordEndpoint = `${apiBaseUrl}/api/auth/forgot-password`;
export const resetPasswordEndpoint = `${apiBaseUrl}/api/auth/reset-password`;
export const requestEmailVerificationEndpoint = `${apiBaseUrl}/api/auth/verify-email/request`;
export const verifyEmailEndpoint = `${apiBaseUrl}/api/auth/verify-email`;
